...
Exam problems for the ["Database Basics" course @ SoftUni](https://softuni.bg/trainings/3965/ms-sql-january-2023)

Submit your solutions in the SoftUni Judge system at [Judge](https://judge.softuni.org/Contests/3888/Databases-MSSQL-Server-Exam-12-Feb-2023)
...
![](RackMultipart20240103-1-eotmjq_html_ea8550a8ad4423d2.png)
...
Select the  **first 5**  **boardgames**  that have rating, bigger than **7.00** and containingthe letter ' **a**' in the boardgame name or the rating of a boardgame is bigger than  **7.50**  and the range of the min and max count of players is **[2;5]**. Order the result by boardgames name ( **ascending** ), then by rating ( **descending** ).
...
Create a user-defined function, named  **udf\_**** CreatorWithBoardgames****(@name)** that receives a creator's first name.
...
| **Query** |
 ...
 |
| --- | --- | --- | --- | --- |
| **EXEC**** usp\_SearchByCategory ****'Wargames'** |
 |
 |
 |
 |
...
![Shape3](RackMultipart20240103-1-eotmjq_html_6f222e41d7629786.gif) ![Shape2](RackMultipart20240103-1-eotmjq_html_5f0f2ddacbac70d2.gif) ![Shape1](RackMultipart20240103-1-eotmjq_html_51bd00be29b85496.gif) ![Shape4](RackMultipart20240103-1-eotmjq_html_f746d52952cd7e91.gif)[![](RackMultipart20240103-1-eotmjq_html_3aa486326bfa75e9.png)](https://softuni.org/)

Follow us:

© SoftUni – [about.softuni.bg](https://about.softuni.bg/). Copyrighted document. Unauthorized copy, reproduction or use is not permitted.

[![](RackMultipart20240103-1-eotmjq_html_9b17934bfedeb713.png)](https://softuni.org/)[![](RackMultipart20240103-1-eotmjq_html_c9db196993f48ff8.png)](https://softuni.bg/)[![Software University @ Facebook](RackMultipart20240103-1-eotmjq_html_94be3df36d913358.png)](https://www.facebook.com/softuni.org)[![](RackMultipart20240103-1-eotmjq_html_7e8e605369b4ad74.png)](https://www.instagram.com/softuni_org)[![Software University @ Twitter](RackMultipart20240103-1-eotmjq_html_ff9c629b0a21eb6b.png)](https://twitter.com/SoftUni1)[![Software University @ YouTube](RackMultipart20240103-1-eotmjq_html_7db86a748da0e575.png)](https://www.youtube.com/channel/UCqvOk8tYzfRS-eDy4vs3UyA)[![](RackMultipart20240103-1-eotmjq_html_95554caa563bbdb3.png)](https://www.linkedin.com/company/softuni/)[![](RackMultipart20240103-1-eotmjq_html_4df51bfadcab813.png)](https://github.com/SoftUni)[![Software University: Email Us](RackMultipart20240103-1-eotmjq_html_d7fa82ab7332f3fa.png)](mailto:info@softuni.org)
